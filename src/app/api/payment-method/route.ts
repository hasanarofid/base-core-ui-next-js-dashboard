...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('Fetching payment method data from:', `${externalApiUrl}/payment-method`)
    console.log('Using session cookie:', sessionCookie.name)

    const response = await fetch(`${externalApiUrl}/payment-method`, {
      method: 'GET',
      headers: {
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Creating tenant at:', `${externalApiUrl}/payment-method`)
    console.log('Using session cookie:', sessionCookie.name)
