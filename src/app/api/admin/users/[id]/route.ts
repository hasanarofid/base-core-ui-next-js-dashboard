...
export async function GET(
  ...
  try {
    ...
    console.log('Fetching user detail from:', `${externalApiUrl}/admin/user/${userId}`)
    console.log('Using session cookie:', sessionCookie.name)

    const response = await fetch(`${externalApiUrl}/admin/user/${userId}`, {
      method: 'GET',
      headers: {
    ...
    console.log('User detail API response data:', data)
