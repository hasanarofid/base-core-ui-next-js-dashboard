...
export async function POST(request: NextRequest) {
  try {
    // Ambil cookies dari request (opsional untuk forgot password publik)
    ...
    console.log('Forgot password data:', body)
    ...
    const response = await fetch(`${externalApiUrl}/forgot-password`, {
      method: 'POST',
      headers,
      body: JSON.stringify({
        email: body.email
