...
export async function POST(
  ...
  try {
    ...
    console.log('Approving tenant at:', `${externalApiUrl}//payment-method/${paymentId}/approve`)
    console.log('Using session cookie:', sessionCookie.name)

    const response = await fetch(`${externalApiUrl}//payment-method/${paymentId}/approve`, {
      method: 'POST',
      headers: {
